...
2. Clone or open the project folder, сreate and activate a virtual environment, install Python dependencies
  cd MNIST_TEST
  python3 -m venv .venv
...
3. Dataset preview pipeline:
  ...
  - Run: python ./scripts/Preview_module/main.py --format yolo --every 1 --max 30
